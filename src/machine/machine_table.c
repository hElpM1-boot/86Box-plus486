...
const machine_t machines[] = {
  // clang-format off
    ...
    {
        .name = "[SiS 496] Chaintech 486SPM (M103)",
        .internal_name = "m103",
        .type = MACHINE_TYPE_486_S3_PCI,
        .chipset = MACHINE_CHIPSET_SIS_496,
        .init = machine_at_m103_init,
        .p1_handler = NULL,
        .gpio_handler = NULL,
        .available_flag = MACHINE_AVAILABLE,
        .gpio_acpi_handler = NULL,
        ...
        .bus_flags = MACHINE_PCI,
        .flags = MACHINE_PS2_KBC | MACHINE_IDE_DUAL, 
        .ram = {
            .min = 1024,
            .max = 131072,
            .step = 1024
    ...
    /* Experimental machine. The hard drives are not working, probably due to ROM fault or IDE controller not supported/seen by BIOS. */
    {
        .name = "[SiS 496] Chaintech 4SPI (P103A) (Experimental)",
        .internal_name = "4spi",
        .type = MACHINE_TYPE_486_S3_PCI,
        .chipset = MACHINE_CHIPSET_SIS_496,
        .init = machine_at_4spi_init,
        .p1_handler = NULL,
        .gpio_handler = NULL,
        .available_flag = MACHINE_AVAILABLE,
        .gpio_acpi_handler = NULL,
    ...
    /* Experimental machine.*/
    {
        .name = "[SiS 496] Chaintech 4SPM5.2 (M104)",
        .internal_name = "4spm",
        .type = MACHINE_TYPE_486_S3_PCI,
        .chipset = MACHINE_CHIPSET_SIS_496,
        .init = machine_at_4spm_init,
        .p1_handler = NULL,
        .gpio_handler = NULL,
        .available_flag = MACHINE_AVAILABLE,
        .gpio_acpi_handler = NULL,
    ...
    /* Experimental machine.*/
    {
        .name = "[SiS 496] Chaintech 486SPM (M104)",
        .internal_name = "m104",
        .type = MACHINE_TYPE_486_S3_PCI,
        .chipset = MACHINE_CHIPSET_SIS_496,
        .init = machine_at_m104_init,
        .p1_handler = NULL,
        .gpio_handler = NULL,
        .available_flag = MACHINE_AVAILABLE,
        .gpio_acpi_handler = NULL,
    ...
    /* Experimental machine. Like the Chaintech 4SPI, this one can't see and use the hard drives.*/
    {
        .name = "[SiS 496] ABIT AB-PV4T",
        .internal_name = "pv4t",
        .type = MACHINE_TYPE_486_S3_PCI,
        .chipset = MACHINE_CHIPSET_SIS_496,
        .init = machine_at_pv4t_init,
        .p1_handler = NULL,
        .gpio_handler = NULL,
        .available_flag = MACHINE_AVAILABLE,
        .gpio_acpi_handler = NULL,
    ...
    /* Experimental machine. */
    {
        .name = "[SiS 496] Amaquest/Anson/Ansoon Technology Co. AP8546",
        .internal_name = "ap8546",
        .type = MACHINE_TYPE_486_S3_PCI,
        .chipset = MACHINE_CHIPSET_SIS_496,
        .init = machine_at_ap8546_init,
        .p1_handler = NULL,
        .gpio_handler = NULL,
        .available_flag = MACHINE_AVAILABLE,
        .gpio_acpi_handler = NULL,
    ...
    {
        .name = "[SiS 496] Amaquest/Anson/Ansoon Technology Co. AP8548",
        .internal_name = "ap8548",
        .type = MACHINE_TYPE_486_S3_PCI,
        .chipset = MACHINE_CHIPSET_SIS_496,
        .init = machine_at_ap8548_init,
        .p1_handler = NULL,
        .gpio_handler = NULL,
        .available_flag = MACHINE_AVAILABLE,
        .gpio_acpi_handler = NULL,
    ...
    /* Experimental machine. */
    {
        .name = "[SiS 496] BEKtronic BEK P407",
        .internal_name = "bekp407",
        .type = MACHINE_TYPE_486_S3_PCI,
        .chipset = MACHINE_CHIPSET_SIS_496,
        .init = machine_at_bekp407_init,
        .p1_handler = NULL,
        .gpio_handler = NULL,
        .available_flag = MACHINE_AVAILABLE,
        .gpio_acpi_handler = NULL,
    ...
    /* Experimental machine. */
    {
        .name = "[SiS 496] Freetech/Flexus 486F55",
    ...
    /* Experimental machine. */
    {
        .name = "[SiS 496] Jetway J446B",
        .internal_name = "j446b",
        .type = MACHINE_TYPE_486_S3_PCI,
        .chipset = MACHINE_CHIPSET_SIS_496,
        .init = machine_at_j446b_init,
        .p1_handler = NULL,
        .gpio_handler = NULL,
        .available_flag = MACHINE_AVAILABLE,
        .gpio_acpi_handler = NULL,
    ...
    /* Experimental machine. */
    {
        .name = "[SiS 496] Totem TM-486SPS",
        .internal_name = "totem",
        .type = MACHINE_TYPE_486_S3_PCI,
        .chipset = MACHINE_CHIPSET_SIS_496,
        .init = machine_at_totem_init,
        .p1_handler = NULL,
        .gpio_handler = NULL,
        .available_flag = MACHINE_AVAILABLE,
        .gpio_acpi_handler = NULL,
    ...
    /* Experimental machine. */
    {
        .name = "[SiS 496] Spring Circle Computer Inc. SS486 Rev. P2C",
        .internal_name = "scc",
        .type = MACHINE_TYPE_486_S3_PCI,
        .chipset = MACHINE_CHIPSET_SIS_496,
        .init = machine_at_scc_init,
        .p1_handler = NULL,
        .gpio_handler = NULL,
        .available_flag = MACHINE_AVAILABLE,
        .gpio_acpi_handler = NULL,
    ...
    {
        .name = "[SiS 496] AOpen AP41",
        .internal_name = "ap41",
        .type = MACHINE_TYPE_486_S3_PCI,
        .chipset = MACHINE_CHIPSET_SIS_496,
        .init = machine_at_ap41_init,
        .p1_handler = NULL,
        .gpio_handler = NULL,
        .available_flag = MACHINE_AVAILABLE,
        .gpio_acpi_handler = NULL,
    ...
    {
        .name = "[SiS 496] ASUS PCI/I-A486S",
        .internal_name = "a486s",
        .type = MACHINE_TYPE_486_S3_PCI,
        .chipset = MACHINE_CHIPSET_SIS_496,
        .init = machine_at_a486s_init,
        .p1_handler = NULL,
        .gpio_handler = NULL,
        .available_flag = MACHINE_AVAILABLE,
        .gpio_acpi_handler = NULL,
    ...
    /* Experimental machine. */
    {
        .name = "[SiS 496] BEYOND 486IP-B-2-A",
        .internal_name = "beyond486",
        .type = MACHINE_TYPE_486_S3_PCI,
        .chipset = MACHINE_CHIPSET_SIS_496,
        .init = machine_at_beyond486_init,
        .p1_handler = NULL,
        .gpio_handler = NULL,
        .available_flag = MACHINE_AVAILABLE,
        .gpio_acpi_handler = NULL,
        ...
        /* Experimental machine. */
    {
        .name = "[SiS 496] Sunvalley S486",
        .internal_name = "svs486",
        .type = MACHINE_TYPE_486_S3_PCI,
        .chipset = MACHINE_CHIPSET_SIS_496,
        .init = machine_at_svs486_init,
        .p1_handler = NULL,
        .gpio_handler = NULL,
        .available_flag = MACHINE_AVAILABLE,
        .gpio_acpi_handler = NULL,
        ...
        /* Experimental machine. */
    {
        .name = "[SiS 496] A-Trend ATC-1425B",
        .internal_name = "atc1425b",
        .type = MACHINE_TYPE_486_S3_PCI,
        .chipset = MACHINE_CHIPSET_SIS_496,
        .init = machine_at_atc1425b_init,
        .p1_handler = NULL,
        .gpio_handler = NULL,
        .available_flag = MACHINE_AVAILABLE,
        .gpio_acpi_handler = NULL,
    ...
    {
        .name = "[SiS 496] EPoX/ProNiX GXA486SPM",
        .internal_name = "gxa486spm",
        .type = MACHINE_TYPE_486_S3_PCI,
        .chipset = MACHINE_CHIPSET_SIS_496,
        .init = machine_at_gxa486spm_init,
        .p1_handler = NULL,
        .gpio_handler = NULL,
        .available_flag = MACHINE_AVAILABLE,
        .gpio_acpi_handler = NULL,
