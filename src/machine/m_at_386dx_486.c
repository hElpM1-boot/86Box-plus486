...
int
machine_at_m103_init(const machine_t *model)
{
    int ret;

    ret = bios_load_linear("roms/machines/m103/bios.bin",
                           0x000e0000, 131072, 0);
...
int
machine_at_pv4t_init(const machine_t *model)
{
    int ret;

    ret = bios_load_linear("roms/machines/pv4t/pv4tbios.bin",
                           0x000e0000, 131072, 0);
...
int
machine_at_ap8546_init(const machine_t *model)
{
    int ret;

    ret = bios_load_linear("roms/machines/ap8546/bios.bin",
                           0x000e0000, 131072, 0);
...
int
machine_at_ap41_init(const machine_t *model)
{
    int ret;

    ret = bios_load_linear("roms/machines/ap41/bios.rom",
                           0x000e0000, 131072, 0);
...
int
machine_at_a486s_init(const machine_t *model)
{
    int ret;

    ret = bios_load_linear("roms/machines/a486s/bios.awd",
                           0x000e0000, 131072, 0);
...
int
machine_at_beyond486_init(const machine_t *model)
{
    int ret;

    ret = bios_load_linear("roms/machines/beyond486/bios.bin",
                           0x000e0000, 131072, 0);
...
int
machine_at_svs486_init(const machine_t *model)
{
    int ret;

    ret = bios_load_linear("roms/machines/svs486/svs486.bin",
                           0x000e0000, 131072, 0);
...
int
machine_at_atc1425b_init(const machine_t *model)
{
    int ret;

    ret = bios_load_linear("roms/machines/atc1425b/bios.bin",
                           0x000e0000, 131072, 0);
...
int
machine_at_gxa486spm_init(const machine_t *model)
{
    int ret;

    ret = bios_load_linear("roms/machines/gxa486spm/bios.bin",
                           0x000e0000, 131072, 0);
...
machine_at_4spi_init(const machine_t *model)
{
    ...
    ret = bios_load_linear("roms/machines/4spi/4spibios.bin",
                           0x000e0000, 131072, 0);
...
int
machine_at_4spm_init(const machine_t *model)
{
    int ret;

    ret = bios_load_linear("roms/machines/4spm/4spmbios.bin",
                           0x000e0000, 131072, 0);
...
int
machine_at_m104_init(const machine_t *model)
{
    int ret;

    ret = bios_load_linear("roms/machines/m104/bios.bin",
                           0x000e0000, 131072, 0);
