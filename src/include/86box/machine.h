...
extern int machine_at_ap8546_init (const machine_t *);
extern int machine_at_ap8548_init(const machine_t *);
extern int machine_at_bekp407_init(const machine_t *);
extern int machine_at_486f55_init (const machine_t *);
extern int machine_at_j446b_init (const machine_t *);
extern int machine_at_totem_init (const machine_t *);
extern int machine_at_scc_init (const machine_t *);
extern int machine_at_ap41_init (const machine_t *);
extern int machine_at_a486s_init (const machine_t *);
extern int machine_at_beyond486_init (const machine_t *);
extern int machine_at_svs486_init (const machine_t *);
extern int machine_at_atc1425b_init (const machine_t *);
extern int machine_at_gxa486spm_init (const machine_t *);
